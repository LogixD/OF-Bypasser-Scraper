...
from data.posts.post import post_media_process_all
...
from data.posts.scrape_paid import (
    process_scrape_paid,
...
from actions.actions.metadata.metadata import metadata_process
from data.posts.post import process_areas
