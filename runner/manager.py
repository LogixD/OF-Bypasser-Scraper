...
import runner.close.exit as exit_manager
import utils.console as console
import utils.logs.logs as logs
import utils.system.system as system
from data.models.manager import ModelManager
from commands.runners.db import db
...
class mainManager():
    ...
    def pick(self):
        import commands.runners.check as check
        import commands.runners.manual as manual
        import commands.runners.metadata.metadata as metadata
        import commands.runners.scraper.scraper as actions
    ...
    def get_session(self,*args,**kwargs):
        import classes.sessionmanager.sessionmanager as sessionManager
        with sessionManager.sessionManager(*args, **kwargs) as c:
            yield c

    @ contextmanager
    def get_ofsession(self,*args,**kwargs):
        import classes.sessionmanager.ofsession as OFsessionManager
